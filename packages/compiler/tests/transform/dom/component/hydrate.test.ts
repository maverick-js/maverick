...
test('simple', () => {
  expect(h(`<Foo />`)).toMatchInlineSnapshot(`
...
test('text child', () => {
  expect(h(`<Foo>Foo</Foo>`)).toMatchInlineSnapshot(`
    "import { $$_create_component } from "@maverick-js/dom";
    function $$_render_1() {
        let $_c_1 = $$_create_component(Foo, null, { "default": () => "Foo" });
        return $_c_1;
    }
    $$_render_1();
    "
...
test('one static child element', () => {
  expect(h(`<Foo><span /></Foo>`)).toMatchInlineSnapshot(`
    "import { $$_create_template, $$_create_walker, $$_create_component } from "@maverick-js/dom";
    ...
    function $$_render_2() {
        let $_c_1 = $$_create_component(Foo, null, { "default": () => $$_render_1() });
        return $_c_1;
    }
    $$_render_2();
    "
...
test('multiple static child elements', () => {
  expect(h(`<Foo><span></span><span></span></Foo>`)).toMatchInlineSnapshot(`
    "import { $$_create_template, $$_create_walker, $$_create_component } from "@maverick-js/dom";
...
test('one dynamic child element', () => {
  expect(h(`<Foo><span on:click={onClick} /></Foo>`)).toMatchInlineSnapshot(`
    "import { $$_create_template, $$_create_walker, $$_listen, $$_create_component, $$_delegate_events } from "@maverick-js/dom";
    let $_t_1 = $$_create_template("<!$><span></span>");
...
test('multiple dynamic child elements', () => {
  expect(h(`<Foo><span on:click={onA}><div on:click={onB} /></span><span on:click={onC} /></Foo>`))
    .toMatchInlineSnapshot(`
    "import { $$_create_template, $$_create_walker, $$_listen, $$_next_element, $$_create_component, $$_delegate_events } from "@maverick-js/dom";
    ...
    function $$_render_3({ $1, $2, $3 }) {
        let $_c_1 = $$_create_component(Foo, null, { "default": () => $$_fragment_1({ $1, $2, $3 }) });
        return $_c_1;
    }
...
test('one dynamic child expression', () => {
  expect(h(`<Foo>{a()}</Foo>`)).toMatchInlineSnapshot(`
    "import { $$_create_component } from "@maverick-js/dom";
    function $$_render_1({ $1 }) {
        let $_c_1 = $$_create_component(Foo, null, { "default": () => null });
        return $_c_1;
...
test('multiple dynamic child expressions', () => {
  expect(
    h(`<Foo>{a() ? <Foo on:click={onA} /> : null}{b() ? <span on:click={onB} /> : null}</Foo>`),
  ).toMatchInlineSnapshot(`
    "import { $$_create_component, $$_listen, $$_create_template, $$_create_walker, $$_delegate_events } from "@maverick-js/dom";
    function $$_render_1({ $1 }) {
        let $_c_1 = $$_create_component(Foo);
    ...
    function $$_render_3({ $5, $6 }) {
        let $_c_2 = $$_create_component(Foo, null, { "default": () => $$_fragment_1({ $5, $6 }) });
        return $_c_2;
    }
