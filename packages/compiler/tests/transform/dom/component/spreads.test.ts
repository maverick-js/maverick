...
test('spread', () => {
  expect(dom('<Foo {...a}  />')).toMatchInlineSnapshot(`
    ...
    function $$_render_1({ $1 }) {
        let $_component_1 = $$_create_component(Foo, $1, null, host => {
            $$_spread(host, $1);
        });
        return $_component_1;
    }
...
test('multiple', () => {
  expect(dom('<Foo {...a} {...b} {...{a: 1, b: 2}} />')).toMatchInlineSnapshot(`
    ...
    function $$_render_1({ $1, $2, $3 }) {
        let $_component_1 = $$_create_component(Foo, $$_merge_props($1, $2, $3), null, host => {
...
test('with attributes', () => {
  expect(
    ...
    function $$_render_1({ $1, $2, $3, $4, $5 }) {
        let $_component_1 = $$_create_component(Foo, $$_merge_props($1, $2), null, host => {
...
test('with props', () => {
  expect(dom('<Foo {...a} {...b} foo={10} bar={20}  />')).toMatchInlineSnapshot(`
    ...
    function $$_render_1({ $1, $2 }) {
        let $_component_1 = $$_create_component(Foo, $$_merge_props($1, $2, {
            "foo": 10,
            "bar": 20
        }), null, host => {
            $$_spread(host, $$_merge_props($1, $2));
