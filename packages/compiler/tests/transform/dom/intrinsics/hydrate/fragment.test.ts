...
test('one static child element', () => {
  expect(h(`<><div /></>`)).toMatchInlineSnapshot(`
...
test('multiple static child elements', () => {
  expect(h(`<><div /><span /></>`)).toMatchInlineSnapshot(`
    "import { $$_create_template, $$_create_walker } from "@maverick-js/dom";
...
test('one dynamic child element', () => {
  expect(h(`<><div on:click={onClick} /></>`)).toMatchInlineSnapshot(`
    "import { $$_create_template, $$_create_walker, $$_listen, $$_delegate_events } from "@maverick-js/dom";
    let $_t_1 = $$_create_template("<!$><div></div>");
...
test('multiple dynamic child elements', () => {
  expect(h(`<><div on:click={onA} /><span on:click={onB} /></>`)).toMatchInlineSnapshot(`
    "import { $$_create_template, $$_create_walker, $$_listen, $$_delegate_events } from "@maverick-js/dom";
    let $_t_1 = $$_create_template("<!$><div></div>"), $_t_2 = $$_create_template("<!$><span></span>");
    function $$_render_1({ $1 }) {
        let [$_r, $_w] = $$_create_walker($_t_1);
...
test('one dynamic child expression', () => {
  expect(h(`<>{a()}</>`)).toMatchInlineSnapshot(`
...
test('multiple dynamic child expressions', () => {
  expect(h(`<>{a() ? <div on:click={onA} /> : null}{b() ? <span on:click={onB} /> : null}</>`))
...
`),
    ...
    "import { $$_create_template, $$_create_walker, $$_create_component, Fragment } from "@maverick-js/dom";
    let $_t_1 = $$_create_template("<!$><div></div>"), $_t_2 = $$_create_template("<!$><span></span>");
    function $$_render_1() {
        let [$_r, $_w] = $$_create_walker($_t_1);
        return $_r;
