...
it('should compile spread', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_spread, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile dynamic attribute', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_attr, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile innerHTML expression', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_inner_html, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile $prop expression', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_prop, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile $class expression', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_class, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile dynamic $style expression', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_style, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should group multiple static $cssvar expressions', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_cssvar, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile $use expression', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_directive, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile $ref expression', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_ref, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile $on expression', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    "import { $$_listen, $$_create_template } from \\"@maverick-js/elements/dom\\";
...
it('should compile conditional element expression ', () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    (() => {
      ...
      $$_insert($$_el, id > 10 && $$_clone($$_templ_2, 1 /* ELEMENT */));
